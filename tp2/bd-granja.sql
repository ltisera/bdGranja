...
BEGIN
INSERT INTO `bd-granja`.`cabaña` (`cuit`, `razonSocial`, `calle`, `numero`, `localidad`, `provincia`) VALUES ( cuit, razonSocial, calle, numero, localidad, provincia);
END ;;
DELIMITER ;
...
-- Dump completed on 2018-10-31 17:10:18
